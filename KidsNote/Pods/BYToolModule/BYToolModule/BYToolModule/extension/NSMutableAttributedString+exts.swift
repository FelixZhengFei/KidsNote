...
public extension NSMutableAttributedString{
  public func ff_allRange()->NSRange{
  ...
  // 字体
  public func ff_font(_ font: UIFont)->NSMutableAttributedString{
  ...
  // 行间距
  public func ff_lineSpace( _ space: CGFloat )->NSMutableAttributedString{
  ...
  public func toString()->FFAttributeString{
