...
@implementation KDWeatherClound
...
-(void)configureView {
    ...
    //鸟 倒影
    self.birdRefImage = [[UIImageView alloc] initWithFrame:CGRectMake(-30, kScreenHeight * 0.7, 70, 50)];
    ...
    self.cloudImageViewF.frame = CGRectMake(0, 0, kScreenHeight *0.47, kScreenWidth*0.5);
    self.cloudImageViewF.center = CGPointMake(kScreenWidth * 0.25, kScreenHeight*0.5);
    ...
    self.cloudImageViewS.center = CGPointMake(kScreenWidth * 0.05, kScreenHeight*0.5);
