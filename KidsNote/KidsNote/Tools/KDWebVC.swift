...
class KDWebVC : KDBaseVC,WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler {
...
extension KDWebVC {
    ...
    fileprivate func configWebView() {
        ...
        smWebView = WKWebView(frame:CGRect(x: 0, y:start_Y, width: kScreen_WIDTH, height: kScreen_HEIGHT - start_Y), configuration: config)
    ...
    fileprivate func creatProgressView() {
        lineProgressView = UIProgressView(frame: CGRect(x: 0, y: start_Y, width: kScreen_WIDTH, height: kScreen_HEIGHT - start_Y))
