...
class FWTabBar: UITabBar {
    ...
    override init(frame: CGRect) {
        ...
        self.backgroundImage = AppDelegate.resizableImage(imageName: (MStatusBar_Height > 20) ? "tabbar_bg_X" : "tabbar_bg", edgeInsets: UIEdgeInsetsMake(0.1, 0, 0, 0))
    }
    ...
    override func layoutSubviews() {
        ...
        if self.frame.height > MTabBar_Height {
            self.frame.size.height = MTabBar_Height
        }
