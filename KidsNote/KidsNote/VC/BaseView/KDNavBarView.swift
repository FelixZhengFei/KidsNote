...
class KDNavBarView: UIView {
    ...
    fileprivate func setupUI() {
        self.frame = CGRect(x: 0, y: 0, width: CGFloat(kScreen_WIDTH), height: kNavBar_H);
    ...
    fileprivate func setupTitleLabel() {
        ...
        titleLabel.frame = CGRect(x: 50, y: kStatusBar_Height, width: kScreen_WIDTH - 100, height: 44)
    ...
    fileprivate func setupLeftButton() {
        ...
        leftButton.frame = CGRect(x: 0, y: kStatusBar_Height, width: 44, height: 44)
    }
}
